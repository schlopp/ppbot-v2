...
class BlackjackState(UtilsEnum):
    """
...
class BlackjackAction(UtilsEnum):
    """
    ...
    def __init__(self, deck: Deck):
        ...
        if total_player.value == 21:
            if total_dealer.value == 21:
                ...
                self.state = BlackjackState.PLAYER_BLACKJACK
        elif total_dealer.value == 21:
            self.state = BlackjackState.DEALER_BLACKJACK
        else:
