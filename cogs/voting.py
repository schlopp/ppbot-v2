    ...
    async def vote_check(self, ctx):
        ...
        if voted:
            return await ctx.send(
                f"You've voted for pp bot on https://top.gg/bot/735147633076863027\nHave fun with your {advert}"
            )
        return await ctx.send(
            f"You haven't voted for pp bot on https://top.gg/bot/735147633076863027\nYou're missing out on a {advert} It's free and takes 10 seconds!"
        )
