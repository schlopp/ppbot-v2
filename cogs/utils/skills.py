...
def get_level_by_exp(exp) -> int:
    ...
    exp_per_level = [
        0,       50,     175,       # 0  1  2
        375,     675,    1_175,     # 3  4  5
        1_925,   2_925,  4_425,     # 6  7  8
        6_425,   9_925,  14_925,    # 9  10 11
        22_425,  32_425, 47_425,    # 12 13 14
        67_425,  97_425, 147_425,   # 15 16 17
        222_425, 322_425, 472425,   # 18 19 20
    ]
...
class Skill:
    ...
    def __init__(self, user_id: int, name: str, experience: typing.Optional[int] = 0):
        self.user_id = user_id
        self.name = name
